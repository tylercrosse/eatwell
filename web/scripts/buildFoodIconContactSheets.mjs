...
const FLUENT = {
  ...
  juice: { folder: 'Cup with straw', file: 'cup_with_straw_flat.svg' },
  ...
  berries: { folder: 'Strawberry', file: 'strawberry_flat.svg' },
  ...
  chips: { folder: 'Potato', file: 'potato_flat.svg' },
  ...
  oil: { folder: 'Oil drum', file: 'oil_drum_flat.svg' },
